...
const {isValidEmail, generateAndSendVerificationCode} = require("../utils/functions.js");
            ...
            if (loginForm(req.body)) {
                ...
                if (client) {
                    ...
                    if (valid) {
                        ...
                        client.smsCode = generateAndSendVerificationCode(client.phone);
                        client.smsTimestamp = Date.now();
                        client.smsUniquelink = uniqid();
                        client.save();
